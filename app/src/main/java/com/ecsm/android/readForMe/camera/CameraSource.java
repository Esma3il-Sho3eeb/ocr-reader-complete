...
public class CameraSource {
    ...
    private int pixel_threshold = 25, threshold = mRequestedPreviewHeight * mRequestedPreviewWidth * 3 / 100;
    ...
    public static class Builder {
        ...
        public Builder setStatusView(@NonNull TextView statusView) {
            mCameraSource.mStatus = statusView;
            return this;
        }
...
//            if (mOldImage == null || mOldImage.length < 10)
//                mOldImage = data;
//            else {
//                for (int i = 0, ij = 0; i < mRequestedPreviewHeight ; i++) {
//                    for (int j = 0; j < mRequestedPreviewWidth ; j++, ij++) {
//                        int pix = (0xff & ((int) data[ij])) - 16;
//                        int otherPix = (0xff & ((int) mOldImage[ij])) - 16;
//
//                        if (pix < 0) pix = 0;
//                        if (pix > 255) pix = 255;
...
//                    }
//                }
//                if (totDifferentPixels < threshold) {
//                    mStatus.setBackground(mStatus.getContext().getDrawable(R.drawable.round_button_green));
//                    mFrameProcessor.setNextFrame(data, camera);
//
//                } else {
//
//                    mStatus.setBackground(mStatus.getContext().getDrawable(R.drawable.round_button_red));
//                }
//                mOldImage=data;
//            }
            mFrameProcessor.setNextFrame(data, camera);
